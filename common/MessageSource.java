 ...
 * 
 * <b> The two concepts have been decoulped from one another:
...
public abstract class MessageSource {
    ...
    protected void closeMessageSource() {
        ...
        for (MessageListener listener : new ArrayList<MessageListener>(messageListeners)) {
            try {
                ...
                /*
                 * We're doing this on a best-effort basos. If something goes wrong, we don't want
     ...
     * 
     * @param message The message this subject receieved.
     */
